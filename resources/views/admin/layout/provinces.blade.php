...
@section('content')
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Input Provices Data</h1>
                ...
                <tr>
                    ...
                    <td>
                        <a type="button" class="btn btn-primary mb-1 mt-1" data-bs-toggle="modal"
                            data-bs-target="#exampleModal1{{ $province->id }}">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </a>
                        <form action="/deleteprovinces" class="d-inline" method="POST">
                            @method('delete')
                            @csrf
                            <input type="hidden" id="" name="id_provinces" value="{{ $province->id }}">
    ...
    @foreach ($provinces as $province)
        <!-- Modal -->
        <div class="modal fade" id="exampleModal1{{ $province->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Update Province Data</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="/updateprovinces" method="POST">
                            @csrf
                            @method('PUT')
                            <input type="hidden" id="" name="id_provinces" value="{{ $province->id }}">
                            <div class="input-group mb-3">
