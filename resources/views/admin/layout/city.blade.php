...
@section('content')
    ...
    <button onclick="ShowModal1()" type="button" class="btn btn-primary mt-2" data-bs-toggle="modal"
        ...
        <table class="table table-striped" style="width:100%" id="data-tables">
            ...
            @foreach ($citys as $city)
                <tr>
                    ...
                    <td>{{ $city->province }}</td>
                    <td>
                        <a onclick="ShowModal2('{{ $city->id }}')" type="button" class="btn btn-primary mb-1 mt-1"
