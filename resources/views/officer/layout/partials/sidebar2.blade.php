    ...
    <ul class="mynav nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item mb-0 dropdown-custom {{ $active === 'data' ? 'dropdown-active-custom' : '' }}">
            ...
            <ul id="dataDropdown">
                ...
                <li class="nav-item mb-1">
                    <a href="/officer-user" class="{{ $title === 'User' ? 'active' : '' }}">
                        <i class="fa-solid fa-user"></i>
                        User
                    </a>
                </li>
                ...
                <li class="nav-item mb-1">
                    <a href="/officer-catalog" class="{{ $title === 'Catalog' ? 'active' : '' }}">
                ...
                <li class="nav-item mb-1">
                    <a href="/officer-transportations" class="{{ $title === 'Transportation' ? 'active' : '' }}">
                        <i class="fa-solid fa-car"></i>
                        Transportations
                    </a>
                </li>
                <li class="nav-item mb-1">
                    <a href="/officer-payments" class="{{ $title === 'Payment Method' ? 'active' : '' }}">
